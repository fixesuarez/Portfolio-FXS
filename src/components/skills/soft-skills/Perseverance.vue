<template>
  <div class="article-content">
    ...
    <p class="article-paragraph">Souvent requise par les entreprises, elle est pour moi étroitement liée avec l'autonomie. En effet, tout développeur doit aujourd'hui être en mesure surmonter les embûches, selon ses missions, qui sont sur sa route.
      <br>Celles-ci peuvent être de nature très diverses:
      <ul>
        <li>Les difficultés techniques quotidiennes,</li>
        <li>Le recueil des besoins du client,</li>
        <li>Les choix d'architecture...</li>
      </ul>
      Toute réussite qui est précédée de difficulté procure soit un soulagement et/ou soit un sentiment de satisfaction, qui permet d'accentuer la soif d'apprendre et qui, quelque part, flatte l'ego du développeur victorieux.
    </p>
    <h3>Situations concrètes</h3>
    <h4>Oméga</h4>
    <p class="article-paragraph">Lors d'un projet étudiant, j'ai été chargé de m'occuper de l'authentification via différentes plateformes. Afin de respecter les normes de sécurité, il m'a fallu me plonger dans une profonde documentation, mais aussi faire face à d'innombrables bugs, pour lesquels j'ai pris un retard considérable sur la suite du projet.
